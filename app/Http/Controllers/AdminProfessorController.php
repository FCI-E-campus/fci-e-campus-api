<?php namespace App\Http\Controllers;
	...
	class AdminProfessorController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			//$this->form[] = ["label"=>"PROFPASSWORD","name"=>"PROFPASSWORD","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
