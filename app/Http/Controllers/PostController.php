...
class PostController extends Controller
{
    ...
    public function showSpecificPostComments(Request $request)
    {
        $post = new Post();
       return $post->showSpecificPostComments($request['POSTID']);
    }
    ...
    {
        $post = new Post();
        return $post->addComment($request['author_username'],$request['author_type'],
