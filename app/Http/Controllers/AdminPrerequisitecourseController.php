<?php namespace App\Http\Controllers;
	...
	class AdminPrerequisitecourseController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "id";
			$this->limit = "20";
			$this->orderby = "prerequisitecourseID,desc";
			...
			# OLD START FORM
			//$this->form = [];
			//$this->form[] = ["label"=>"PrerequisitecourseID","name"=>"prerequisitecourseID","type"=>"number","required"=>TRUE,"validation"=>"required|integer|min:0"];
			//$this->form[] = ["label"=>"COURSECODE","name"=>"COURSECODE","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			//$this->form[] = ["label"=>"COU COURSECODE","name"=>"COU_COURSECODE","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
			# OLD END FORM
