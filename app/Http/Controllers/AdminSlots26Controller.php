<?php namespace App\Http\Controllers;
	...
	class AdminSlots26Controller extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->form[] = ['label'=>'DURATION','name'=>'DURATION','type'=>'number','validation'=>'required|integer|min:0','width'=>'col-sm-10'];
