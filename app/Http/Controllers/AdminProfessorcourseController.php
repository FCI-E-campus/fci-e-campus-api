<?php namespace App\Http\Controllers;
	...
	class AdminProfessorcourseController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->title_field = "id";
			$this->limit = "20";
			$this->orderby = "professorcourseID,desc";
			...
			$this->table = "professorcourse";
			# END CONFIGURATION DO NOT REMOVE THIS LINE

			# START COLUMNS DO NOT REMOVE THIS LINE
			$this->col = [];
			$this->col[] = ["label"=>"ProfessorcourseID","name"=>"professorcourseID"];
